# Generated by Django 3.1.2 on 2021-03-13 14:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('high_school_passing_year', models.CharField(blank=True, default=True, max_length=4, null=True)),
                ('intern_cource', models.CharField(blank=True, default=True, max_length=100, null=True)),
                ('startdate', models.CharField(default=True, max_length=100)),
                ('enddate', models.CharField(default=True, max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('calling', models.CharField(default=True, max_length=10)),
                ('whatsapp', models.CharField(default=True, max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='Staff',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('other_univercity', models.CharField(blank=True, max_length=100, null=True)),
                ('other_year', models.CharField(blank=True, default=True, max_length=4, null=True)),
                ('trainee_cource', models.CharField(blank=True, default=True, max_length=100, null=True)),
                ('startdate', models.CharField(default=True, max_length=100)),
                ('enddate', models.CharField(default=True, max_length=100)),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('half_day', models.CharField(default='No', max_length=100)),
                ('date', models.CharField(blank=True, default='13-03-2021', max_length=100)),
